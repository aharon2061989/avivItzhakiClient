        ...
        <div>
            <div className="severancePayInfoHeader">
                ...
                <div className="infoText">
                    ...
                    <h4> בעמוד זה נסקור את נושא פיצויי הפיטורין והחזר המס עבור עובדים ששילמו מס מירבי בעת משיכת הפיצויים מחברת הביטוח בין השנים 2018 ועד 2023.</h4>
                    ...
                    <h2>ביצעתם משיכת כפסי פיצויי פיטורין מחברת הביטוח</h2>
                    <h2> בין השנים  2019-2024 ?</h2>
                    <h2>פנו אלינו לייעוץ מקצועי ולבדוק את זכאותכם להחזרי מס</h2>
                    <h2>ייתכן שמגיע לכם סכומים נכבדים שיכולים לשפר את מצבכם הכלכלי</h2>
